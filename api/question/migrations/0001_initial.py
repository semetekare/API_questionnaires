    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when_to_show_statistic', models.CharField(choices=[('1', 'сразу после прохождения теста'), ('2', 'после разрешения от препода')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('1', 'единичный ответ'), ('2', 'множественный ответ'), ('3', 'расчетное задание')], max_length=1)),
                ('ok_comment', models.CharField(default=None, max_length=128)),
                ('bad_comment', models.CharField(blank=True, default=None, max_length=128)),
